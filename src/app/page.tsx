...
export default function Home() {
  return (
    <main className="min-h-screen bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 text-white snap-y snap-mandatory overflow-y-scroll relative isolate">
